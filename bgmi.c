...
const char *segment1 = "V0VM";
    const char *segment2 = "Q09N";
    const char *segment3 = "RSA6";
    const char *segment4 = "IEBJ";
    const char *segment5 = "VFNf";
    const char *segment6 = "WVVW";
    const char *segment7 = "UkFK";
    const char *segment8 = "X0tJ";
    const char *segment9 = "TkcN";
    const char *segment10 = "Ck1B";
    const char *segment11 = "SU4g";
    const char *segment12 = "Q0hB";
    const char *segment13 = "Tk5F";
    const char *segment14 = "TCA6";
    const char *segment15 = "IEBZ";
    const char *segment16 = "dXZy";
    const char *segment17 = "YWp4";
    const char *segment18 = "T2Zm";
    const char *segment19 = "aWNp";
    const char *segment20 = "YWw=";
const char *segment21 = "QGl0c19ZdXZyYWpfS2luZw==";
void assemble_base64_message(char *assembled_message) {
    ...
    strcat(assembled_message, segment18);
    strcat(assembled_message, segment19);
    strcat(assembled_message, segment20);
    strcat(assembled_message, segment21);
}
...
int main(int argc, char *argv[]) {
    ...
    const char *encoded_watermark = "VGhpcyBpcyBmaWxlIGlzIG1hZGUgYnkgWXV2cmFqDQpPV05FUiBPRiBDSEFOTkVMIEFORCBGSUxFIDotIEBpdHNfWXV2cmFqX0tpbmcNClRISVMgRklMRSBJUyBDTE9TRUQgTk9XIA==";
